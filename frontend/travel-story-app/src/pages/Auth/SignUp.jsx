    ...
    <div className="container h-screen flex items-center justify-center px-20 mx-auto">
      ...
      >
        <div>
          ...
          <p className="text-[15px] text-white font-semibold leading-6 pr-7 mt-4">Create your account to start documenting your travels and preserving your memories in your personal travel journal.</p>
        </div>
      </div>
